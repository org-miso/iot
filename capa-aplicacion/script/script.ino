...
const char ssid[] = "DIGIFIBRA-USdN"; // TODO cambiar por el nombre de la red WiFi
// Contraseña de la red WiFi
const char pass[] = "TfQPRh9QU2Gk"; // TODO cambiar por la contraseña de la red WiFi
...
const char MQTT_HOST[] = "44.211.210.146"; // TODO Reemplace ip.maquina.mqtt por la IP del bróker MQTT que usted desplegó. Ej: 192.168.0.1
...
const char MQTT_TOPIC_PUB[] = "espania/leon/leon/" USER "/out"; //TODO Reemplace el valor por el tópico de publicación que le corresponde.
// El tópico de suscripción debe tener estructura: <país>/<estado>/<ciudad>/<usuario>/in
const char MQTT_TOPIC_SUB[] = "espania/leon/leon/" USER "/in"; //TODO Reemplace el valor por el tópico de suscripción que le corresponde.
