...
const char ssid[] = "DIGIFIBRA-USdN";
//Contraseña de la red Wifi
const char pass[] = "TfQPRh9QU2Gk";

//Usuario uniandes sin @uniandes.edu.co
#define HOSTNAME "j.albarracinp"

//Conexión a Mosquitto
const char MQTT_HOST[] = "iotlab.virtual.uniandes.edu.co";
const int MQTT_PORT = 8082;
//Usuario uniandes sin @uniandes.edu.co
const char MQTT_USER[] = "j.albarracinp";
...
const char MQTT_PUB_TOPIC1[] = "humedad/leon_espania/" HOSTNAME;
//Tópico al que se enviarán los datos de temperatura
const char MQTT_PUB_TOPIC2[] = "temperatura/leon_espania/" HOSTNAME;
//Tópico al que se enviarán los datos de intensidad luminica
const char MQTT_PUB_TOPIC3[] = "luminosidad/leon_espania/" HOSTNAME;

const int fotoresistorPin = A0; // Pin analógico al que está conectado el fotoresistor
int fotoresistorValue = 0; // Variable para almacenar el valor del fotoresistor
...
void loop()
{
  ...
  fotoresistorValue = analogRead(fotoresistorPin); // Leer el valor del fotoresistor desde el pin A0

  // Imprimir el valor del fotoresistor en el monitor serial
  ...
  json = "{\"value\": "+ String(fotoresistorValue) + "}";
  ...
  if ( !isnan(h) && !isnan(t) ) {
    ...
    //Publica en el tópico de la luminoidad
